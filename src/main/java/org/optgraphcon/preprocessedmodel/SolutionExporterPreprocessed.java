...
/**
 * Export solutions to the preprocessed problem.
 */
public class SolutionExporterPreprocessed {
    ...
    public SolutionExporterPreprocessed(SpatialPlanningModelPreprocessed problem, Solution solution, String rastDest, double noDataValue) {
