...
import org.optgraphcon.grid.regular.square.GroupedGrid;
...
/**
 * Export solutions to the naive version of the problem.
 */
public class SolutionExporterNaive {
    ...
    public SolutionExporterNaive(SpatialPlanningModelNaive problem, Solution solution, String rastDest, double noDataValue) {
